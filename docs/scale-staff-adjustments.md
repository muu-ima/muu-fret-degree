...
| 2026-07-08 | Dorian | Eb | Compact | `staveY: 19`, `noteScale: 0.9`, `accidentalScale: 0.82`, `noteShift: 4`, `signatureReserve: 68`, `noteOffsets: { 2: 2, 6: 2 }`, `labelOffsets: { 2: 1, 6: 1 }` | 5つのフラットで左側が詰まりやすいため、臨時記号を小さくしつつb3のGbとb7のDbを少し右へ逃がし、8度EbがC Dorianの終点位置に近づくようにするため。 |
